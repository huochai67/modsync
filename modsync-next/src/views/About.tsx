    ...
    <div className="max-w-4xl mx-auto space-y-12 animate-in fade-in zoom-in-95 duration-500">
      <section className="text-center space-y-4">
        ...
        <h1 className="text-4xl font-extrabold text-white">
          GitLens Pro Visualizer
        </h1>
        <p className="text-xl text-slate-400 max-w-2xl mx-auto">
          A high-performance git diff inspection tool designed for developers
          who demand depth in their version control insights.
        </p>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="p-8 bg-slate-900 border border-slate-800 rounded-2xl space-y-4">
          ...
          <p className="text-slate-400 text-sm leading-relaxed">
            Analyze line-by-line changes with syntax highlighting and semantic
            grouping for better code reviews.
          </p>
        </div>
        <div className="p-8 bg-slate-900 border border-slate-800 rounded-2xl space-y-4">
          ...
          <p className="text-slate-400 text-sm leading-relaxed">
            Automatic MD5 and SHA-256 checksum comparison ensures your binary
            and text files are exactly what you expect.
          </p>
        </div>
        <div className="p-8 bg-slate-900 border border-slate-800 rounded-2xl space-y-4">
          ...
          <p className="text-slate-400 text-sm leading-relaxed">
            Optimized parsing engine handles massive repositories with thousands
            of changed files without breaking a sweat.
          </p>
        </div>
      </div>
